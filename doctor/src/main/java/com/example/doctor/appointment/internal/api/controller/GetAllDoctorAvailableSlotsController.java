...
@AllArgsConstructor
public class GetAllDoctorAvailableSlotsController {
    private final IGetAllDoctorHandler iGetAllDoctorHandler;


    @GetMapping
    public ResponseEntity<List<DoctorSlotResponseDTO>> getAllAppointments(@ModelAttribute GetAllDoctorSlotsRequest requestDTO) {
